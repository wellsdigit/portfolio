...
const socialIcon = [
  {
    ...
    link: "https://github.com/wellsdigit",
  },
  {
    id: 2,
    iconName: "icon-linkedin-squared",
    link: "https://www.linkedin.com/in/wellshub/",
  },
  {
    id: 3,
    iconName: "icon-twitter-squared",
    link: "https://twitter.com/wellshub_fr",
  },
];
const Home = () => {
  return (
          ...
          <div className="home_content flex items-center">
            ...
            <div className="details ml-[80px]">
              <h3 className="name text-[55px] font-extrabold uppercase mb-[14px]">
                Godwin <span>Salami</span>
              </h3>
              <p className="job font-montserrat font-medium max-w-[450px] mb-[25px]">
              I am a dedicated Frontend web developer who excels in crafting functionalities perfectly tailored to the task at hand.
              </p>
